...
# Filter rows where the erosion column has non-missing values
data = data.dropna(subset=['Erosion'], how='any')
...
joblib.dump(rf_model_erosion, 'rf_model_erosion_presence.pkl')
...
accuracy_filename = 'erosion_presence_model_accuracy.txt'
