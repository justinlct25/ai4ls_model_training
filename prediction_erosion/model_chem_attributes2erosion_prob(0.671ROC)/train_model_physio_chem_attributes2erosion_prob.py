...
erosion_columns = ['EROSION_SHEET', 'EROSION_RILL', 'EROSION_GULLY', 'EROSION_MASS', 'EROSION_DEP', 'EROSION_WIND']

# Define the target variable as the presence or absence of erosion
data['Erosion'] = data[erosion_columns].max(axis=1)
...
# Filter rows where either the erosion column column has non-missing values
# data = data.dropna(subset=erosion_columns, how='any')
